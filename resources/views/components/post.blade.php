<div class="flex flex-wrap">
  <div class="flex flex-col flex-grow flex-shrink w-full col-span-1 p-6 md:w-1/3">
    ...
    <div class="flex-none p-3 mt-auto overflow-hidden bg-white rounded-t-none rounded-b shadow-md">
      <div class="flex items-center justify-start">
        <a href="#"
          class="px-3 py-2 mx-auto my-6 font-bold text-white transition duration-300 ease-in-out transform rounded-full shadow-lg lg:mx-0 hover:underline gradient focus:outline-none focus:shadow-outline hover:scale-105">
          Read More
        </a>
      </div>
    </div>
