    ...
    <div class="relative flex flex-col items-center">
          ...
          <div class="flex flex-wrap flex-auto">
            ...
            <template x-for="(option,index) in selected" :key="options[option].value">
              ...
              <div class="flex items-center justify-center px-1 py-1 m-1 font-medium bg-white border rounded">
                <div class="flex-initial max-w-full text-xs font-normal leading-none" x-model="options[option]"
      ...
      <div class="w-full px-4">
        <div x-show.transition.origin.top="isOpen()"
          class="absolute left-0 z-40 w-full bg-white rounded shadow top-100 max-h-select" x-on:click.away="close">
